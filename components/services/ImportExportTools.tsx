...
export function ImportExportTools() {
  ...
  return (
    <div style={{ display: "flex", gap: 8 }}>
      <button onClick={handleExport} className="btn btn-secondary btn-sm" disabled={loading}>
      ...
      <label className={`btn btn-secondary btn-sm ${loading ? 'opacity-50' : ''}`} style={{ cursor: "pointer" }}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="14" height="14">
